...
import {TiArrowLeftThick,TiArrowRight, TiArrowRightThick} from 'react-icons/ti';
...
if(direction == "left"){
    ...
    <div className={Style.slider}>
        ...
        <div className={Style.slider_box_button_btn}>
            ...
            <TiArrowLeftThick  className={Style.slider_box_button_btn_icon_1}/>
            </div>
            <div className={Style.slider_box_button_btn_icon} onClick={()=> handleScroll("right")}>
            <TiArrowRightThick  className={Style.slider_box_button_btn_icon_1}/>
            </div>
        </div>
    </div>
